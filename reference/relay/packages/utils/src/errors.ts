...
export class BrokerNotRunningError extends RelayError {
  constructor(message?: string) {
    super(message || 'Relay broker is not running. Start with: agent-relay up');
    this.name = 'BrokerNotRunningError';
  }
}

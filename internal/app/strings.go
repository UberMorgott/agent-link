...
var uiStrings = map[string]string{ //nolint:gosec // G101: UI sentences; keys like error.conflict_secret name errors, not credentials
	...
	"inbox.participants.label":      "Участники чата",
	...
	"inbox.archive_history.title":   "Убрать историю чата в архив и начать его заново с теми же участниками",
	...
	"project.leave.text":              "Проект «{name}» и его чаты пропадут из списка у вас; у остальных участников всё останется. Файлы чатов сохранятся в папке данных agentlink. Вернуться можно по приглашению.",

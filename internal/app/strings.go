...
var uiStrings = map[string]string{
	...
	"settings.agent.hint":          "Обычно находится сама. Если нет — нажмите «Указать…» и выберите codex.cmd / codex.exe или claude.exe.",
	"settings.agent.from_path":     "Найдена в PATH: {path}",
	"settings.agent.from_setting":  "Указана: {path}",
	"settings.agent.gone":          "Не найдена: {path} — нажмите «Указать…» и выберите программу заново.",
	"settings.agent.missing":       "Не найдена — нажмите «Указать…».",
	"settings.agent.found":         "Найден: {path}",
	...
	"error.handler_missing":        "Программа агента не найдена — нажмите «Указать…» и выберите codex.exe / claude.exe, или установите агента (для Codex: npm i -g @openai/codex).",

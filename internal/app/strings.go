...
var uiStrings = map[string]string{
	...
	"error.chat_legacy":            "Это переписка из старой версии, в неё нельзя написать — начните новую беседу.",
	...
	"inbox.legacy_note":        "Переписка из старой версии — её можно только читать.",

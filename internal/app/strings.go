...
var uiStrings = map[string]string{ //nolint:gosec // G101: UI sentences; keys like error.conflict_secret name errors, not credentials
	...
	"theme.surface":           "Фон",
	"theme.font":              "Шрифт",
	"theme.font.inter":        "Inter — по умолчанию",
	"theme.font.inter.hint":   "Ровный и чёткий, как в современных мессенджерах",
	"theme.font.manrope":      "Manrope — мягкий",
	"theme.font.manrope.hint": "Округлый и чуть шире, спокойный для длинной переписки",
	"theme.font.plex":         "IBM Plex Sans — строгий",
	"theme.font.plex.hint":    "Технический, хорошо различает похожие буквы и цифры",
	"theme.font.system":       "Системный",
	"theme.font.system.hint":  "Шрифт Windows (Segoe UI), ничего не загружает",
	"theme.color.noir":        "Чёрно-белый",
	"theme.color.emerald":     "Изумрудный",
	"theme.color.green":       "Зелёный",
	"theme.color.teal":        "Бирюзовый",
	"theme.color.sky":         "Небесный",
	"theme.color.blue":        "Синий",
	"theme.color.indigo":      "Индиго",
	"theme.color.violet":      "Фиолетовый",
	"theme.color.amber":       "Янтарный",
	"theme.color.orange":      "Оранжевый",
	"theme.color.rose":        "Розовый",
	"theme.surface.slate":     "Сланцевый",
	"theme.surface.gray":      "Серый",
	"theme.surface.zinc":      "Цинковый",
	"theme.surface.neutral":   "Нейтральный",
	"theme.surface.stone":     "Каменный",
	"theme.saved":             "Оформление сохраняется только в этом браузере.",
	"theme.unsaved":           "Браузер не сохраняет настройки. Выбор действует до перезагрузки.",
	...
	"link.no_code":            "нет ни одного проекта — создайте проект или присоединитесь по приглашению",
	...
	"link.weak_code":          "у «Прежней сети» старый короткий код, а agentlink доступен не только из локальной сети — перейдите в проект и выйдите из «Прежней сети»",
	...
	"tray.quit":          "Выход",
	"tray.stop_all":      "Остановить всех агентов",
	...
	"tray.weak_code":     "слабый код «Прежней сети»",

	// Settings page.
	"settings.h1":                  "Настройки",
	"settings.identity.title":      "Профиль",
	...
	"settings.projects.title":      "Папки тем",
	"settings.projects.hint":       "Вопрос на тему из списка агент решает в её папке, а не в рабочей папке. Тема сама добавится в «Общие темы».",
	"settings.projects.empty":      "Папок тем нет — все вопросы агент решает в рабочей папке.",
	"settings.projects.area":       "Тема",
	"settings.projects.dir":        "Папка темы",
	...
	"settings.projects.add":        "Добавить папку темы",
	...
	// Agent autonomy (autonomy.go, AutonomySettings.vue).
	"autonomy.title":           "Автономия агентов",
	"autonomy.intro":           "Здесь вы решаете, насколько самостоятельно агенты работают друг с другом без вас: может ли agentlink сам открывать и будить сессии агентов, сколько раз подряд агенты могут отвечать друг другу и сколько им можно работать без перерыва. Всё сохраняется сразу.",
	"autonomy.stop.label":      "Аварийная остановка: остановить всех агентов",
	"autonomy.stop.hint":       "Включено: agentlink сразу прерывает запущенные им ходы агентов и больше не будит, не открывает и не запускает агентов ни в одном проекте. Сообщения не теряются — они ждут непрочитанными, пока вы не выключите остановку. Сессия, в которой вы сейчас работаете сами, по-прежнему видит сообщения при своих действиях. Выключено: агенты работают так, как настроено ниже для каждого проекта. Тот же переключатель есть в меню значка agentlink в трее.",
	"autonomy.stop.on":         "Агенты остановлены: ничего не запускается само, пока вы не выключите остановку.",
	"autonomy.none":            "Проектов пока нет — настраивать нечего.",
	"autonomy.project":         "Проект «{name}»",
	"autonomy.mode.label":      "Самостоятельность агентов",
	"autonomy.mode.off":        "Выключена",
	"autonomy.mode.asked":      "Только на вопросы",
	"autonomy.mode.full":       "Полная",
	"autonomy.mode.off.hint":   "Выключена: agentlink сам не открывает сессию агента в этом проекте. Сообщения получают только сессии, которые вы открыли сами; если сессии нет, сообщения ждут вас. Самый осторожный вариант.",
	"autonomy.mode.asked.hint": "Только на вопросы: если другой участник или его агент задаёт вопрос вашему компьютеру, а сессии агента в папке проекта нет, agentlink откроет её сам и передаст вопрос. Сообщения без вопроса к вам (просто для сведения) ждут вас. Открытая сессия работает с вашими полными правами агента.",
	"autonomy.mode.full.hint":  "Полная: сессию агента открывает и будит любое сообщение других участников, даже без вопроса к вам, — агенты могут вести работу между собой часами без вас. Работают лимиты ниже: когда лимит исчерпан, автономная работа встаёт на паузу, а в трее появляется уведомление с предложением продолжить. Риск: пока лимит не исчерпан, агенты тратят токены и меняют файлы в папке проекта с вашими полными правами.",
	"autonomy.depth.label":     "Лимит ответов агентов друг другу подряд",
	"autonomy.depth.hint":      "Сколько раз подряд агенты могут отвечать друг другу, пока в разговор не вмешается человек; дальше вопрос встаёт на паузу «нужен человек». 0 — без лимита. Пусто — по умолчанию: 8 в режимах «Выключена» и «Только на вопросы», без лимита в режиме «Полная». Без лимита агенты могут переписываться бесконечно — тогда их останавливают только лимиты ходов и времени ниже.",
	"autonomy.depth.default":   "Сейчас по умолчанию: {value}",
	"autonomy.depth.unlimited": "без лимита",
	"autonomy.turns.label":     "Ходов агентов в час (режим «Полная»)",
	"autonomy.turns.hint":      "Сколько раз за любой час agentlink может сам разбудить, открыть или запустить агента в этом проекте. Лимит исчерпан — автономная работа встаёт на паузу, пока вы не нажмёте «Продолжить». От 1 до 600; пусто — 30.",
	"autonomy.run.label":       "Минут непрерывной работы (режим «Полная»)",
	"autonomy.run.hint":        "Сколько минут подряд агенты могут работать сами. Перерыв дольше 15 минут без самостоятельных ходов начинает отсчёт заново. Лимит исчерпан — пауза, пока вы не нажмёте «Продолжить». От 10 до 1440; пусто — 240 (4 часа).",
	"autonomy.used":            "За последний час: {turns} из {limit} ходов; без перерыва: {minutes} из {max} мин.",
	"autonomy.paused":          "Пауза: {reason}. Сообщения ждут непрочитанными.",
	"autonomy.reason.turns":    "исчерпан лимит ходов в час",
	"autonomy.reason.run":      "агенты работали без перерыва дольше лимита",
	"autonomy.resume":          "Продолжить",
	"autonomy.saved":           "Сохранено.",
	"autonomy.paused.title":    "agentlink: агенты на паузе",
	"autonomy.paused.turns":    "Проект «{project}»: исчерпан лимит ходов агентов в час. Нажмите, чтобы открыть настройки и продолжить.",
	"autonomy.paused.run":      "Проект «{project}»: агенты работали без перерыва дольше лимита. Нажмите, чтобы открыть настройки и продолжить.",
	...
	"error.nickname":               "Ник — от 1 до 32 символов, без запятых и пробелов по краям.",
	"error.nickname_taken":         "Этот ник уже занят другим участником проекта (имя, ник или прежний ник). Выберите другой.",
	"error.attachment":             "Вложение не принято.",
	"error.attachment_type":        "Прикрепить можно изображения (PNG, JPEG, GIF, WebP), PDF и текстовые файлы.",
	"error.attachment_size":        "Слишком большое вложение: до 10 МБ на файл, до 10 файлов и 50 МБ на сообщение.",
	...
	"error.unknown_chat":           "Такого чата нет — обновите страницу (F5).",
	"error.chat_closed":            "Чат завершён — чтобы продолжить тему, начните новый чат.",
	...
	"error.chat_participants":      "Выберите участников проекта, которые уже подключались к нему; себя выбрать нельзя.",
	"error.chat_owner":             "Менять состав чата может только тот, кто его начал.",
	...
	"inbox.author.fyi":       "— ваш агент получит это для сведения",

	// Inbox page: the open chat.
	"inbox.empty_conversation":     "В чате пока нет сообщений.",
	"inbox.back":                   "Назад",
	"inbox.close":                  "Завершить чат",
	"inbox.close.legacy":           "Убрать в архив",
	"inbox.close.confirm":          "Завершить чат? Он завершится у всех участников: писать в него больше будет нельзя, история останется в архиве. Продолжить тему можно в новом чате.",
	...
	"inbox.closed_note":            "Чат завершил(а) {name}, {when}. Чтобы продолжить тему, начните новый чат.",
	...
	"inbox.new_with":               "Новый чат с {names}",
	"inbox.older":                  "Показать более ранние",
	"inbox.event.open":             "{name} начал(а) чат",
	"inbox.event.close":            "{name} завершил(а) чат",
	"inbox.event.open_self":        "вы начали чат",
	"inbox.event.close_self":       "вы завершили чат",
	"inbox.event.archive":          "{name} очистил(а) чат — сообщения сохранены в «Истории»",
	"inbox.event.archive_self":     "вы очистили чат — сообщения сохранены в «Истории»",
	"inbox.event.reopen":           "{name} очистил(а) чат — прежние сообщения в «Истории»",
	"inbox.event.reopen_self":      "вы очистили чат — прежние сообщения в «Истории»",
	"inbox.archived_note":          "Это история чата: его очистил(а) {name}, {when}. Разговор продолжается в чате проекта.",
	"inbox.archived_note.open":     "Открыть чат проекта",
	"inbox.event.members":          "{name} изменил(а) состав: {names}",
	"inbox.event.members_self":     "вы изменили состав: {names}",
	"inbox.members.add":            "Позвать в чат",
	"inbox.members.add_button":     "Позвать",
	"inbox.members.remove":         "Убрать из чата",
	"inbox.members.remove_confirm": "Убрать {name} из чата? Новые сообщения до него больше не дойдут.",
	"inbox.removed_note":           "Вас убрали из этого чата — писать в него нельзя, история осталась.",
	...
	"inbox.tick.agent_read":        "прочитано агентом на этом компьютере",
	"inbox.tick.agent_unread":      "ещё не прочитано агентом на этом компьютере",
	"inbox.author.is_agent":        "написал агент",
	"inbox.author.is_human":        "написал человек",
	"inbox.clear":                  "Очистить чат",
	"inbox.clear.confirm":          "Очистить чат у всех участников? Текущие сообщения сохранятся в «Истории» проекта (с датой), а чат продолжится пустым с теми же участниками.",
	"inbox.history":                "История",
	"inbox.history.title":          "История чата",
	"inbox.history.hint":           "Очищенные чаты проекта. Их можно открыть и прочитать, но не дополнить. Агенты читают их командой chats с archive и history.",
	"inbox.history.empty":          "Чат ещё не очищали.",
	"inbox.history.cleared":        "Очищен {when} · {name}",
	"inbox.history.untitled":       "Без сообщений",
	...
	"inbox.attach":           "Прикрепить файл",
	"inbox.attach.remove":    "Убрать вложение",
	"inbox.attach.uploading": "загружается…",
	"inbox.attach.failed":    "файл не получен",
	"inbox.attach.download":  "Скачать",
	"inbox.attach.drop":      "Отпустите, чтобы прикрепить",
	"inbox.attach.bytes":     "{n} Б",
	"inbox.attach.kb":        "{n} КБ",
	"inbox.attach.mb":        "{n} МБ",
	"inbox.attach.too_many":  "Не больше {n} файлов в одном сообщении.",
	"inbox.attach.too_big":   "Файл {name} больше 10 МБ.",
	"inbox.attach.too_much":  "Вместе файлы больше 50 МБ.",
	...
	"error.autonomy":                  "Недопустимое значение автономии: ходов в час — от 1 до 600, минут непрерывной работы — от 10 до 1440, лимит ответов подряд — от 0 до 250.",
	...
	"projects.dot.none":                 "Агенты не открыты ни на одном компьютере проекта",
	"projects.dot.one":                  "Агент открыт на одном компьютере: {names}",
	"projects.dot.many":                 "Агенты открыты на {n} компьютерах: {names}",
	"projects.dot.you":                  "{name} (вы)",
	"project.start_chat":                "Начать чат",
	"profile.title":                     "Мой ник и цвет в чате",
	"profile.chip":                      "Мой профиль: {name}",
	"profile.nickname":                  "Ник",
	"profile.nickname.hint":             "Так вас видят другие участники. Имя «{name}» остаётся за вами: агенты и команды находят вас и по нему, и по прежним никам.",
	"profile.nickname.empty":            "Введите ник.",
	"profile.color":                     "Мой цвет в чате",
	"profile.color.hint":                "Этим цветом другие участники видят ваше имя и ваши сообщения — и ваши, и ваших агентов.",
	"profile.color.blue":                "Синий",
	"profile.color.violet":              "Фиолетовый",
	"profile.color.pink":                "Розовый",
	...
	"project.state.needs_folder":        "Папка проекта не выбрана: переписываться можно, но ваш агент не отвечает.",
	...
	"project.menu.autonomy":             "Автономия агентов…",
	"project.menu.leave":                "Выйти из проекта",
	"project.menu.agents":               "Агенты",
	...
	"project.agents.stop":               "Остановить",
	"project.agents.remove":             "Убрать",
	"project.agents.remove_confirm":     "Убрать агента «{name}» из разговора? Его сессия останется в приложении агента.",
	"project.agents.status.active":      "работает",
	"project.agents.status.idle":        "ждёт",
	"project.agents.status.running":     "отвечает",
	"project.agents.status.closed":      "не открыт — ответит, когда его спросят",
	...
	"project.invite.title":              "Приглашение в проект",
	"project.invite.hint":               "Отправьте приглашение тем, кого зовёте: они вставят его в «Присоединиться». По приглашению можно войти в проект — не публикуйте его.",
	"project.invite.hint_legacy":        "Код прежней сети: другой участник вводит его в «Присоединиться».",
	"project.invite.show":               "Показать приглашение",
	"project.invite.hide":               "Скрыть приглашение",
	"project.invite.copy":               "Копировать",
	"project.invite.copied":             "Приглашение скопировано.",
	"project.invite.copy_manual":        "Нажмите Ctrl+C, чтобы скопировать выделенное приглашение.",
	"project.name.title":                "Общее имя проекта",
	"project.name.hint":                 "Название видят все участники, и переименовать его может любой из них.",
	"project.name.label":                "Название",
	"project.folder.title":              "Моя папка",
	"project.folder.hint":               "Папка проекта на этом компьютере: в ней ваш агент отвечает участникам. Её видите только вы.",
	"project.folder.label":              "Папка",
	"project.folder.warn":               "Участники проекта могут через вашего агента менять файлы и запускать команды в этой папке.",
	"project.alias.label":               "Своё название (необязательно)",
	"project.alias.hint":                "Только у вас: участникам не отправляется.",
	"project.leave.title":               "Выйти из проекта?",
	"project.leave.text_legacy":         "Код прежней сети будет удалён из настроек, история сообщений останется. Вернуться можно, снова введя код в «Присоединиться».",
	"project.leave.submit":              "Выйти",
	"project.menu.delete":               "Удалить проект",
	"project.delete.title":              "Удалить проект?",
	"project.delete.text":               "Проект «{name}» удаляется только на этом компьютере: вы выйдете из него, он и его чаты пропадут из вашего списка, а файлы чатов уйдут в архив в папке данных agentlink. У остальных участников проект и вся переписка останутся. Вернуться можно по приглашению.",
	"project.delete.submit":             "Удалить",
	"project.members.remove":            "Удалить из проекта",
	"project.members.remove_confirm":    "Удалить {name} из проекта? Его удалят у всех участников: сообщения проекта до него больше не дойдут. Вернуть его можно, снова добавив его адрес.",
	"project.members.removed":           "{name} удалён из проекта.", "project.cancel": "Отмена",
	"project.save":               "Сохранить",
	"projects.new":               "Новый проект",
	"projects.join":              "Присоединиться",
	"project.create.title":       "Новый проект",
	"project.create.hint":        "У проекта свои участники и чаты, а у каждого участника — своя папка проекта. Папку можно выбрать и позже.",
	"project.create.folder":      "Папка (необязательно)",
	"project.create.submit":      "Создать",
	"project.join.title":         "Присоединиться к проекту",
	"project.join.hint":          "Вставьте приглашение, которое прислал участник проекта.",
	"project.join.invite":        "Приглашение или код прежней сети",
	"project.join.addr":          "Адрес участника (необязательно)",
	"project.join.addr_hint":     "Нужен, только если участник не в вашей локальной сети и не в ZeroTier: его IP, например 10.147.20.9.",
	"project.join.connecting":    "Подключаюсь — жду, пока ответит кто-нибудь из участников…",
	"project.join.wait":          "Не ждать",
	"project.join.joined":        "Вы в проекте «{name}». Выберите папку, в которой ваш агент будет отвечать участникам, — или сделайте это позже.",
	"project.join.done":          "Готово",
	"project.join.cancel_hint":   "Вы уже в проекте. «Отмена» — выйти из него.",
	"project.join.work_dir":      "Рабочая папка прежней сети",
	"project.join.work_dir_hint": "Ваш агент отвечает участникам прежней сети в этой папке — выберите её и нажмите «Присоединиться» снова.",
	"settings.legacy.title":      "Прежняя сеть",
	"settings.legacy.hint":       "Сеть, настроенная до проектов, со своим кодом связи. Её код и выход из неё — в меню «Прежней сети» в списке проектов.",

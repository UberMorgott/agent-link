...
var uiStrings = map[string]string{
	...
	"settings.projects.empty":      "Проектов нет — все вопросы агент решает только на чтение в рабочей папке.",
	"settings.projects.area":       "Тема",
	"settings.projects.dir":        "Папка проекта",
	"settings.projects.write":      "Разрешить изменения",
	"settings.projects.write_hint": "Любой участник с вашим кодом связи, приславший вопрос на эту тему, сможет через агента менять файлы в этой папке и запускать в ней команды.",
	...
	"inbox.select":             "Выберите участника",
	"inbox.select_hint":        "Выберите участника слева, чтобы открыть переписку.",

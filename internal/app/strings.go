...
var uiStrings = map[string]string{ //nolint:gosec // G101: UI sentences; keys like error.conflict_secret name errors, not credentials
	...
	"inbox.archive.hide":     "Скрыть архив",
	...
	"inbox.event.archive":           "{name} убрал(а) историю чата в архив",
	"inbox.event.archive_self":      "вы убрали историю чата в архив",
	"inbox.event.reopen":            "{name} начал(а) чат заново — прежняя история в архиве",
	"inbox.event.reopen_self":       "вы начали чат заново — прежняя история в архиве",
	"inbox.archive_history":         "Очистить историю",
	"inbox.archived_note":           "Это история из архива: её убрал(а) {name}, {when}. Разговор продолжается в чате проекта.",
	"inbox.archived_note.open":      "Открыть чат проекта",
	"inbox.archive_history.confirm": "Убрать историю чата в архив? У всех участников она уйдёт в архив проекта (её можно открыть там), а чат сразу начнётся заново с теми же участниками.",
	...
	"inbox.new.count":        "Выбрано: {n} из {total}",
	"inbox.new.hint":         "Все участники видят все сообщения. Можно никого не выбирать: позвать или убрать участников можно потом, в подробностях чата.",
	"inbox.new.create":       "Начать чат",
	"inbox.new.dismiss":      "Отмена",
	"inbox.new.no_members":   "Пока некого позвать — чат будет только ваш. Участников проекта можно позвать в него потом.",
